...
type GetTelemetryResponse struct {
	...
	TimeBootMs  uint32  `protobuf:"varint,1,opt,name=time_boot_ms,json=timeBootMs,proto3" json:"time_boot_ms,omitempty"`  // Timestamp of last message in milliseconds
...
func (x *GetTelemetryResponse) GetTimeBootMs() uint32 {
	if x != nil {
		return x.TimeBootMs
	}
	return 0
...
type GetDetailedTelemetryResponse struct {
	...
	Airspeed    float32 `protobuf:"fixed32,8,opt,name=airspeed,proto3" json:"airspeed,omitempty"`                         // Airspeed in m/s
	Groundspeed float32 `protobuf:"fixed32,9,opt,name=groundspeed,proto3" json:"groundspeed,omitempty"`                   // Groundspeed in m/s
	Battery     int32   `protobuf:"varint,10,opt,name=battery,proto3" json:"battery,omitempty"`                           // Remaining battery energy. Values: [0-100], -1:
	// autopilot does not estimate the remaining battery.
	Autonomous bool `protobuf:"varint,11,opt,name=autonomous,proto3" json:"autonomous,omitempty"` // True if the UAV is in a mode being controlled
	// autonomously, False otherwise
	Target *Target `protobuf:"bytes,12,opt,name=target,proto3,oneof" json:"target,omitempty"` // Target being locked on by the UAV
}
...
func (x *GetDetailedTelemetryResponse) GetTimeBootMs() uint32 {
	if x != nil {
		return x.TimeBootMs
	}
	return 0
...
var file_proto_mastermind_v1_mastermind_proto_rawDesc = []byte{
	...
	0x6d, 0x65, 0x74, 0x72, 0x79, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0xf9, 0x01, 0x0a,
	...
	0x6f, 0x74, 0x5f, 0x6d, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0a, 0x74, 0x69, 0x6d,
	...
	0x75, 0x6e, 0x64, 0x73, 0x70, 0x65, 0x65, 0x64, 0x22, 0x52, 0x0a, 0x06, 0x54, 0x61, 0x72, 0x67,
	...
	0x65, 0x74, 0x72, 0x79, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0xfa, 0x02, 0x0a, 0x1c,
	0x47, 0x65, 0x74, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x65, 0x64, 0x54, 0x65, 0x6c, 0x65, 0x6d,
	...
	0x28, 0x0d, 0x52, 0x0a, 0x74, 0x69, 0x6d, 0x65, 0x42, 0x6f, 0x6f, 0x74, 0x4d, 0x73, 0x12, 0x10,
	...
	,
	...
	,
	...
	,
	...
	,
...
var file_proto_mastermind_v1_mastermind_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_proto_mastermind_v1_mastermind_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_proto_mastermind_v1_mastermind_proto_goTypes = []interface{}{
	...
	(*GetTelemetryRequest)(nil),          // 4: mastermind.v1.GetTelemetryRequest
	(*GetTelemetryResponse)(nil),         // 5: mastermind.v1.GetTelemetryResponse
	(*Target)(nil),                       // 6: mastermind.v1.Target
	(*GetDetailedTelemetryRequest)(nil),  // 7: mastermind.v1.GetDetailedTelemetryRequest
	(*GetDetailedTelemetryResponse)(nil), // 8: mastermind.v1.GetDetailedTelemetryResponse
}
var file_proto_mastermind_v1_mastermind_proto_depIdxs = []int32{
	...
	6, // 4: mastermind.v1.GetDetailedTelemetryResponse.target:type_name -> mastermind.v1.Target
	2, // 5: mastermind.v1.MastermindService.UpdateState:input_type -> mastermind.v1.UpdateStateRequest
	4, // 6: mastermind.v1.MastermindService.GetTelemetry:input_type -> mastermind.v1.GetTelemetryRequest
	7, // 7: mastermind.v1.MastermindService.GetDetailedTelemetry:input_type -> mastermind.v1.GetDetailedTelemetryRequest
	3, // 8: mastermind.v1.MastermindService.UpdateState:output_type -> mastermind.v1.UpdateStateResponse
	5, // 9: mastermind.v1.MastermindService.GetTelemetry:output_type -> mastermind.v1.GetTelemetryResponse
	8, // 10: mastermind.v1.MastermindService.GetDetailedTelemetry:output_type -> mastermind.v1.GetDetailedTelemetryResponse
