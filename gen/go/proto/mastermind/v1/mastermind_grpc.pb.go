...
const (
	...
	MastermindService_SetCommand_FullMethodName           = "/mastermind.v1.MastermindService/SetCommand"
...
type MastermindServiceClient interface {
	...
	// SetCommand roll,pitch and thrust for guidance
	SetCommand(ctx context.Context, in *SetCommandRequest, opts ...grpc.CallOption) (*SetCommandResponse, error)
...
func (c *mastermindServiceClient) SetCommand(ctx context.Context, in *SetCommandRequest, opts ...grpc.CallOption) (*SetCommandResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SetCommandResponse)
	err := c.cc.Invoke(ctx, MastermindService_SetCommand_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// All implementations must embed UnimplementedMastermindServiceServer
...
type MastermindServiceServer interface {
	...
	// SetCommand roll,pitch and thrust for guidance
	SetCommand(context.Context, *SetCommandRequest) (*SetCommandResponse, error)
	// GotoWaypoint commands the plane to go to specified waypoint
...
// UnimplementedMastermindServiceServer must be embedded to have
...
func (UnimplementedMastermindServiceServer) SetCommand(context.Context, *SetCommandRequest) (*SetCommandResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SetCommand not implemented")
}
...
func (UnimplementedMastermindServiceServer) mustEmbedUnimplementedMastermindServiceServer() {}
...
func _MastermindService_SetCommand_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SetCommandRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MastermindServiceServer).SetCommand(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MastermindService_SetCommand_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MastermindServiceServer).SetCommand(ctx, req.(*SetCommandRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var MastermindService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _MastermindService_SetCommand_Handler,
		},
		{
