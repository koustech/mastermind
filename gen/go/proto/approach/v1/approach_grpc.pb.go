...
func (c *approachServiceClient) GetPlanes(ctx context.Context, in *GetPlanesRequest, opts ...grpc.CallOption) (ApproachService_GetPlanesClient, error) {
	stream, err := c.cc.NewStream(ctx, &ApproachService_ServiceDesc.Streams[0], ApproachService_GetPlanes_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *approachServiceClient) ApproachPlane(ctx context.Context, in *ApproachPlaneRequest, opts ...grpc.CallOption) (*ApproachPlaneResponse, error) {
	...
	err := c.cc.Invoke(ctx, ApproachService_ApproachPlane_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
